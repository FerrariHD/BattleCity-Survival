...
public class Game {
  ...
  public void pause() {
    timer.stop();
    Music.activateEngineSound(false);
    MenuItem cont = new MenuItem("Continue");
    MenuItem exitGame = new MenuItem("Exit");
    SubMenu pauseMenu = new SubMenu(cont, exitGame);
  ...
  public void gameOver() {
    timer.stop();
    Music.activateEngineSound(false);
    MenuItem mainMenu = new MenuItem("Р“Р›РђР’РќРћР• РњР•РќР®");
    MenuItem exitGame = new MenuItem("Р’Р«РҐРћР”");
